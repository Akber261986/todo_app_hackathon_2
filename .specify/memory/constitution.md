...
Technology stack requirements: OpenAI ChatKit for frontend, FastAPI for backend, OpenAI Agents SDK for AI logic, Official MCP SDK for tool exposure, SQLMds for ORM, JWT for authentication, Better Auth for user management.
